    ...
    <div className='px-6 md:px-16 lg:px-40 pt-30 md:pt-50'>
      <div className='flex flex-col md:flex-row gap-8 max-w-6xl mx-auto'>
        ...
        <div className="relative flex flex-col gap-3">
          ...
          <div className='flex items-center flex-wrap gap-4 mt-4 '>
            ...
            rounded-md font-medium cursor-pointer active:scale-95'>Buy Ticket</a>
         ...
         <div className='flex items-center gap-4 w-max px-4'>
          {show.movie.casts.slice(0,12).map((cast,index)=>(
            <div key={index} className='flex flex-col items-center text-center'>
              <img src={cast.profile_path} alt="" className='rounded-full h-20 w-20
              md:h-20 aspect-sqaure object-cover' />
      ...
      <p className='text-lg font-medium mt-20 mb-8'>You May Also Like</p>
              <div className="flex flex-wrap max-sm:justify-center gap-8">
                {dummyShowsData.slice(0,4).map((moive,index)=>(
                  <MovieCard key={index} movie={moive}/>
                ))}
              </div>
